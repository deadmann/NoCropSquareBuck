...
//https://stackoverflow.com/questions/1038206/net-c-sharp-library-for-lossless-exif-rewriting
...
{
    public class ExifHandlerMicrosoft : IExifHandler
    {
        public object GetValue(PropertyItem pi)
        {
            if (pi.Type == 1)
                return pi.Value[0];
            if (pi.Type == 2)
        ...
        public List<PropertyItem> Read(Stream str)
        {
            throw new NotImplementedException();
        }

        /// <summary>
        /// https://stackoverflow.com/questions/1038206/net-c-sharp-library-for-lossless-exif-rewriting <br/>
        /// https://docs.microsoft.com/en-us/windows/desktop/gdiplus/-gdiplus-constant-image-property-tag-constants
        /// </summary>
        /// <param name="str"></param>
        /// <param name="properties"></param>
        public void Write(Stream str, List<PropertyItem> properties)
        {
            throw new NotImplementedException();
        }

        public List<PropertyItem> Read(Image img)
        {
            var result = new List<PropertyItem>();
            var PIs = img.PropertyItems;
            foreach (var definedProperty in PIs)
            {
                foreach (var p in MicrosoftDefinedPropertyList)
                {
                    if (definedProperty.Id == p)
                    {
        ...
        public IEnumerable<int> MicrosoftDefinedPropertyList
        {
            get
            {
                var enumerator = typeof(ImageMicrosoftDefinedProperties).GetEnumValues().GetEnumerator();
                enumerator.Reset();
        ...
        public void Write(Image img, List<PropertyItem> properties)
        {
        ...
        /// https://docs.microsoft.com/en-us/windows/desktop/gdiplus/-gdiplus-constant-image-property-tag-constants
        /// </summary>
        public enum ImageMicrosoftDefinedProperties
        {
